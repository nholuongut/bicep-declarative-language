    ...
    public static class DiagnosticBuilder
    {
        ...
        public class DiagnosticBuilderInternal
        {
            ...
            public Diagnostic DeprecatedProvidersFunction(string functionName) => CoreWarning(
                "BCP241",
                $"The \"{functionName}\" function is deprecated and will be removed in a future release of Bicep. Please add a comment to https://github.com/nholuongut/bicep-declarative-language/issues/2017 if you believe this will impact your workflow.")
            ...
            public Diagnostic ExtensionDeclarationKeywordIsDeprecated(ExtensionDeclarationSyntax syntax)
            {
                ...
                return CoreWarning(
                    "BCP381",
                    @$"Declaring extension with the ""{syntax.Keyword.Text}"" keyword has been deprecated. Please use the ""extension"" keyword instead. Please see https://github.com/nholuongut/bicep-declarative-language/issues/14374 for more information.")
                    with { Fixes = [codeFix] };
            }
