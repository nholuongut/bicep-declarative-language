...
namespace Bicep.Core.Registry
{
    public sealed class OciArtifactRegistry : ExternalArtifactRegistry<OciArtifactReference, OciArtifactResult>
    {
        ...
        {
            // Example: https://github.com/nholuongut/bicep-declarative-language-registry-modules/tree/app/dapr-containerapp/1.0.2/modules/app/dapr-containerapp/README.md
            return $"https://github.com/nholuongut/bicep-declarative-language-registry-modules/tree/{publicModuleName}/{tag}/modules/{publicModuleName}/README.md";
        }
        ...
        protected override void WriteArtifactContentToCache(OciArtifactReference reference, OciArtifactResult result)
        {
            ...
            //   and not main.json directly (https://github.com/nholuongut/bicep-declarative-language/issues/11900)
            ...
            if (result is OciModuleArtifactResult moduleArtifact)
            {
                ...
                if (result.TryGetSingleLayerByMediaType(BicepMediaTypes.BicepSourceV1Layer) is BinaryData sourceData)
                {
                    ...
                    //  (https://github.com/nholuongut/bicep-declarative-language/issues/11900)
