...
namespace Bicep.Core.Emit
{
    public class InlineDependencyVisitor : AstVisitor
    {
        ...
        private void VisitPropertyAccessSyntaxInternal(PropertyAccessSyntax syntax)
        {
            ...
            // resources and modules (id, name, type, apiVersion). Once https://github.com/nholuongut/bicep-declarative-language/issues/1177 is fixed,
            ...
            switch (this.TryResolveSymbol(syntax.BaseExpression))
            {
                ...
                // and move to using the assigned type once https://github.com/nholuongut/bicep-declarative-language/issues/1177 is fixed.
