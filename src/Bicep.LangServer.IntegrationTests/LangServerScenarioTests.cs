...
public class LangServerScenarioTests
{
    ...
    {
        // repro for https://github.com/nholuongut/bicep-declarative-language/issues/1931#issuecomment-1088061552
...
```");
    ...
    [TestMethod]
    public async Task Test_Issue13254() // https://github.com/nholuongut/bicep-declarative-language/issues/13254
    {
