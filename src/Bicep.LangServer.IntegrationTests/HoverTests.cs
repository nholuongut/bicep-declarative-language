...
"));
        ...
        public async Task Function_hovers_display_without_descriptions_if_function_overload_has_not_been_resolved()
        {
            ...
            // this should be taken care of with https://github.com/nholuongut/bicep-declarative-language/issues/4588
            var hovers = await RequestHoversAtCursorLocations(@"
...
",
        ...
        [DataRow(
            ...
            null, // description
             ...
             "```bicep\nmodule test 'br:mcr.microsoft.com/bicep/app/dapr-containerapps-environment:1.0.1'\n```  \n[View Documentation](https://github.com/nholuongut/bicep-declarative-language-registry-modules/tree/app/dapr-containerapps-environment/1.0.1/modules/app/dapr-containerapps-environment/README.md)  \n")]
        [DataRow(
            null,
            ...
            null, // description
             ...
             // documentationUri calculated from MCR location
             "```bicep\nmodule test 'br:mcr.microsoft.com/bicep/app/dapr-containerapps-environment:1.0.2'\n```  \n[View Documentation](https://github.com/nholuongut/bicep-declarative-language-registry-modules/tree/app/dapr-containerapps-environment/1.0.2/modules/app/dapr-containerapps-environment/README.md)  \n")]
        //
...
";
        ...
        {
            // https://github.com/nholuongut/bicep-declarative-language/issues/12412
            var (text, cursor) = ParserHelper.GetFileWithSingleCursor("""
                type foo = {
...
");
        ...
        {
            // https://github.com/nholuongut/bicep-declarative-language/issues/13398
            var (text, cursor) = ParserHelper.GetFileWithSingleCursor("""
                type foo = {
                  @description('''Source port ranges.
                    Can be a single valid port number, a range in the form of \<start\>-\<end\>, or a * for any ports.
...
");
        ...
        {
            // https://github.com/nholuongut/bicep-declarative-language/issues/13982
            var (text, cursor) = ParserHelper.GetFileWithSingleCursor("""
type obj = {
...
""");
        ...
        {
            // https://github.com/nholuongut/bicep-declarative-language/issues/14864
