...
See https://github.com/nholuongut/bicep-declarative-language/blob/main/CONTRIBUTING.md#updating-test-baselines for more information on how to fix this error.
");
                }
                else
                {
