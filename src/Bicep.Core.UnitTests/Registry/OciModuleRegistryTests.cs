...
namespace Bicep.Core.UnitTests.Registry
{
   ...
   ""annotations"": {
      ...
      ""org.opencontainers.image.notdescription"": """ + "description" + @"""
        ...
        {
            var documentationUri = @"https://github.com/nholuongut/bicep-declarative-language-registry-modules/blob/main/modules/samples/hello-world/README.md";
            var manifestFileContents = @"{
   ""schemaVersion"": 2,
   ""artifactType"": ""application/vnd.ms.bicep.module.artifact"",
   ""config"": {
   ...
   params: {
     ...
     daprComponentScopes: [
       'nodeapp'
            ...
            result.Should().NotBeNull();
            result.Should().BeEquivalentTo("https://github.com/nholuongut/bicep-declarative-language-registry-modules/tree/app/dapr-containerapps-environment/bicep/core/1.0.1/modules/app/dapr-containerapps-environment/bicep/core/README.md");
        }
   ...
   ""layers"": [
     {
       ...
       ""size"": 735131,
       ""annotations"": {
         ""org.opencontainers.image.documentation"": ""https://github.com/nholuongut/bicep-declarative-language-registry-modules/blob/main/modules/samples/hello-world/README.md""
       }
     }
   ]
 }";
        ...
        {
            var description = @"My description is this: https://github.com/nholuongut/bicep-declarative-language-registry-modules/blob/main/modules/samples/hello-world/README.md";
            var manifestFileContents = @"{
   ""schemaVersion"": 2,
   ""artifactType"": ""application/vnd.ms.bicep.module.artifact"",
   ""config"": {
