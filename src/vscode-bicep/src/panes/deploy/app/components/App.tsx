        ...
        <>
          <FormSection title="Experimental Warning">
            <div className="alert-error">
              ...
              <a href="https://github.com/nholuongut/bicep-declarative-language/blob/main/docs/experimental/deploy-ui.md">here</a>. Please raise
...
`;
  ...
  return `https://github.com/nholuongut/bicep-declarative-language/issues/new?title=${encodeURIComponent(title)}&body=${encodeURIComponent(body)}&labels=${encodeURIComponent(labels.join(","))}`;
}
