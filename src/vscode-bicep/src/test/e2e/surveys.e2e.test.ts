  ...
  describe("getIsSurveyAvailable", () => {
    it("active aka survey link", async () => {
      ...
      const isAvailable = await Survey.getIsSurveyAvailable(
        context,
        // This test depends on this aka.ms link existing and being active (can point to https://github.com/nholuongut/bicep-declarative-language/)
    ...
    it("inactive aka survey link", async () => {
      ...
      const isAvailable = await Survey.getIsSurveyAvailable(
        context,
        // This test depends on this aka.ms link existing and being set to inactive (can point to https://github.com/nholuongut/bicep-declarative-language/)
    ...
    it("other status code returned", async () => {
      ...
      const isAvailable = await Survey.getIsSurveyAvailable(context, "https://github.com/nholuongut/bicep-declarative-language");
