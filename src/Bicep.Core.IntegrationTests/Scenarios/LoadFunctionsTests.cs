        ...
        public static IEnumerable<object[]> LoadFunction_InvalidPath_Data
        {
            get
            {
                foreach (var function in new[] { FunctionCase.loadTextContent, FunctionCase.loadFileAsBase64 })
                {
                    ...
                    yield return new object[] { function, "github://nholuongut/bicep-declarative-language/@main/samples/script.sh" };
...
"),
        ...
        /// <summary>
        /// https://github.com/nholuongut/bicep-declarative-language/issues/7208
        /// </summary>
        [TestMethod]
