...
param testUri = uri('github.com', 'nholuongut/bicep-declarative-language')
//@[16:48) [BCP033 (Error)] Expected a value of type "object" but the provided value is of type "string". (bicep https://aka.ms/bicep/core-diagnostics#BCP033) |uri('github.com', 'nholuongut/bicep-declarative-language')|
//@[16:48) [BCP338 (Error)] Failed to evaluate parameter "testUri": The template language function 'uri' expects its first argument to be a uri string. The provided value is 'github.com'. Please see https://aka.ms/arm-function-datauri for usage details. (bicep https://aka.ms/bicep/core-diagnostics#BCP338) |uri('github.com', 'nholuongut/bicep-declarative-language')|
//@[20:47) [BCP234 (Warning)] The ARM function "uri" failed when invoked on the value [github.com, nholuongut/bicep-declarative-language]: The template language function 'uri' expects its first argument to be a uri string. The provided value is 'github.com'. Please see https://aka.ms/arm-function-datauri for usage details. (bicep https://aka.ms/bicep/core-diagnostics#BCP234) |'github.com', 'nholuongut/bicep-declarative-language'|
